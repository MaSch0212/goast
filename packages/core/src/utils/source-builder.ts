...
import { defaultStringBuilderOptions, type StringBuilderOptions } from './string-builder/options.ts';
import { type AppendParam, type BuilderFn, StringBuilder } from './string-builder/string-builder.ts';
import type { AppendValue } from './string-builder/utils.ts';
...
export class SourceBuilder<TAdditionalAppends = never> extends StringBuilder<TAdditionalAppends> {
  ...
  public get isCurrentLineEmpty(): boolean {
    return this._isCurrentLineEmpty;
  }
