import type { SourceBuilderOptions } from '@goast/core';

import { expect } from '@std/expect';
import { beforeEach, describe, it } from '@std/testing/bdd';

import { ImportExportCollection } from './import-collection.ts';
...
describe('ImportExportCollection', () => {
  ...
  beforeEach(() => {
    collection = new ImportExportCollection({ importModuleTransformer: 'omit-extension' });
