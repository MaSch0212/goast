...
interface Service2Api {
     ...
     */
    class UntaggedResponseEntity<T> private constructor(
        body: T,
        rawStatus: Int,
     ...
     */
    class PathServerResponseEntity<T> private constructor(
        body: T,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
     ...
     */
    class OpServerResponseEntity<T> private constructor(
        body: T,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
