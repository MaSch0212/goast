...
interface DeprecationApi {
     ...
     */
    class DeprecatedOpResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
     ...
     */
    class DeprecatedOpNoDescResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
     ...
     */
    class DeprecatedParamsResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
