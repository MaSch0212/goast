...
interface ParamsApi {
     ...
     */
    class AllLocationsResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
     ...
     */
    class StyleMatrixResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
     ...
     */
    class PathStyleSimpleResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
     ...
     */
    class GetEncodedResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
