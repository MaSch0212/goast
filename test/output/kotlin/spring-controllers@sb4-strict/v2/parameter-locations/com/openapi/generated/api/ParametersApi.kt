...
interface ParametersApi {
     ...
     */
    class BodyParamResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
     ...
     */
    class FormDataParamsResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
     ...
     */
    class FileUploadResponseEntity<T : Any> private constructor(
        body: T?,
        rawStatus: Int,
        headers: MultiValueMap<String, String>? = null
    ) : ResponseEntity<T>(body, headers, rawStatus) {
