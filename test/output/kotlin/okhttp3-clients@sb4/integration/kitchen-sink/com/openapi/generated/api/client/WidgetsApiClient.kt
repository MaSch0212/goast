...
class WidgetsApiClient(
    ...
    fun getWidget(id: String): Widget {
        val localVarResponse = getWidgetWithHttpInfo(id)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as Widget
    ...
    fun getWidgetWithHttpInfo(id: String): ApiResponse<Widget?> {
        val localVariableConfig = getWidgetRequestConfig(id)
        return request<Unit, Widget>(localVariableConfig)
    }

    /**
     * To obtain the request config of the operation getWidget
     */
    private fun getWidgetRequestConfig(id: String): RequestConfig<Unit> {
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/widgets/${encodeURIComponent(id.toString())}",
