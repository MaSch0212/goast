...
class TagWithSpaceApiClient(
    ...
    fun tagWithSpace(): Unit {
        val localVarResponse = tagWithSpaceWithHttpInfo()
    ...
    fun tagWithSpaceWithHttpInfo(): ApiResponse<Unit?> {
        val localVariableConfig = tagWithSpaceRequestConfig()
        return request<Unit, Unit>(localVariableConfig)
    }

    /**
     * To obtain the request config of the operation tagWithSpace
     */
    private fun tagWithSpaceRequestConfig(): RequestConfig<Unit> {
