...
class ParametersApiClient(
    ...
    fun bodyParam(): Unit {
        val localVarResponse = bodyParamWithHttpInfo()
    ...
    fun bodyParamWithHttpInfo(): ApiResponse<Unit?> {
        val localVariableConfig = bodyParamRequestConfig()
        return request<Unit, Unit>(localVariableConfig)
    }

    /**
     * To obtain the request config of the operation bodyParam
     */
    private fun bodyParamRequestConfig(): RequestConfig<Unit> {
    ...
    fun formDataParams(): Unit {
        val localVarResponse = formDataParamsWithHttpInfo()
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun formDataParamsWithHttpInfo(): ApiResponse<Unit?> {
        val localVariableConfig = formDataParamsRequestConfig()
        return request<Unit, Unit>(localVariableConfig)
    }

    /**
     * To obtain the request config of the operation formDataParams
     */
    private fun formDataParamsRequestConfig(): RequestConfig<Unit> {
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        return RequestConfig(
            method = RequestMethod.POST,
    ...
    fun fileUpload(): Unit {
        val localVarResponse = fileUploadWithHttpInfo()
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun fileUploadWithHttpInfo(): ApiResponse<Unit?> {
        val localVariableConfig = fileUploadRequestConfig()
        return request<Unit, Unit>(localVariableConfig)
    }

    /**
     * To obtain the request config of the operation fileUpload
     */
    private fun fileUploadRequestConfig(): RequestConfig<Unit> {
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        return RequestConfig(
            method = RequestMethod.POST,
    ...
    fun queryParams(tags: Any? = null, ids: Any? = null): Unit {
        val localVarResponse = queryParamsWithHttpInfo(tags, ids)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun queryParamsWithHttpInfo(tags: Any? = null, ids: Any? = null): ApiResponse<Unit?> {
        val localVariableConfig = queryParamsRequestConfig(tags, ids)
        return request<Unit, Unit>(localVariableConfig)
    }
     ...
     */
    private fun queryParamsRequestConfig(tags: Any? = null, ids: Any? = null): RequestConfig<Unit> {
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
                if (tags != null) {
